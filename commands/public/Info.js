module.exports = Cmds.addCommand({
	...
	func: (cmd, args, msgObj, speaker, channel, guild) => {
		...
		var isMuted = Mutes.checkMuted(target.id, guild);
		var historyStr = Util.historyToString(Util.getHistory(target.id, guild));

		var createdAt = target.createdAt || target.user.createdAt;
		var timeStr = Util.getYearStr(createdAt) + "-" + Util.getMonthStr(createdAt) + "-" + Util.getDayStr(createdAt);
